...
@TeleOp(name = "Mech Crash Avoidance v0.0.1 lol")

public class MechCrashAvoidance extends OpMode {

    DcMotor fLeft, fRight, bLeft, bRight;
    DistanceSensor leftD, centerD, rightD;
    BNO055IMU imu;
    Orientation angles;
    ...
    public void init(){
        ...
        centerD = hardwareMap.get(DistanceSensor.class, "centerD");
